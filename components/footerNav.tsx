const companyLinks = [
  ...
  { href: '/rules', label: 'Quy chế' },
  { href: '/terms', label: 'Điều khoản sử dụng' },
  { href: '/privacy', label: 'Bảo mật thông tin' },
  { href: '/complaints', label: 'Giải quyết khiếu nại' },
  { href: '/contact', label: 'Liên hệ' },
  { href: '/driver-partner', label: 'Hợp tác nhân viên giao nhận' },
  { href: '/merchant-register', label: 'Đăng kí quán' },
];

export default function FooterNav() {
  return (
    <footer
      className="z-50 mt-4 flex w-full flex-row justify-items-center bg-white"
      style={{ gap: '10rem' }}
    >
      <section className="flex flex-col items-start" style={{ marginLeft: '180px' }}>
        <h2 className="m-0 text-[25px] font-bold">Công ty</h2>
        <nav className="mt-5 flex flex-col items-start text-blue-500" aria-label="Liên kết công ty">
      ...
      <section className="flex flex-col items-center" aria-labelledby="app-links-title">
        <h2 id="app-links-title" className="m-0 text-[25px] font-bold">
          Ứng dụng Baemin
        </h2>
        <div className="mt-5 flex flex-col items-start">
          <a
            href="https://www.apple.com/app-store/"
            className="rounded border border-solid border-gray-300 px-4 py-2 text-sm font-medium"
          >
            App Store
          </a>
          <a
            href="https://play.google.com/store"
            className="mt-2 rounded border border-solid border-gray-300 px-4 py-2 text-sm font-medium"
          >
            Google Play
          </a>
        </div>
      </section>
      <section className="flex flex-col items-center" aria-label="Baemin brand">
        <div className="mt-10 flex flex-col items-center">
          ...
          <span className="mt-3">Baemin 2024</span>
        </div>
      </section>
      <address className="flex flex-col items-end not-italic">
        <h2 className="m-0 text-[25px] font-bold">Địa chỉ công ty</h2>
        <div className="mt-5 flex flex-col items-end">
          ...
          <a href="mailto:baemin@gmail.com">Email: baemin@gmail.com</a>
        </div>
      </address>
    </footer>
  );
