        ...
        <div className="z-50 w-full mt-4  bg-white flex flex-row justify-items-center" style={{ gap: "10rem" }}>
            ...
            <div className="flex flex-col items-center">
                ...
                <div className="content flex flex-col items-start mt-5">
                    <span className="rounded border border-solid border-gray-300 px-4 py-2 text-sm font-medium">
                        App Store
                    </span>
                    <span className="mt-2 rounded border border-solid border-gray-300 px-4 py-2 text-sm font-medium">
                        Google Play
                    </span>
